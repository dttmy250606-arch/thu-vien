...
with col_kiosk:
    ...
    with st.container(border=True):
        ...
        st.button(" IN VÉ NGAY", on_click=process_ticket, use_container_width=True)
...
st.markdown("<br><hr><center><small>System developed by Tra My </small></center>", unsafe_allow_html=True)
